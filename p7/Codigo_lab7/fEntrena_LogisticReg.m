...
% DESCENSO DEL GRADIENTE PARA ACTUALIZACION DE THETA
    ...
    for num_iter=1:max_iter
        ...
        % a. Resultado intermedio: calcula las (h_i-y_i)*x para CADA patron de entrenamiento
        error_total = 0;
        theta_old = theta;
        % ====================== YOUR CODE HERE ======================
        suma = 0;
        for i=1:m
           x_i = [1, X_train(i,:)];
            ...
            result = (h_train(i)- Y_train(i))* x_i;
            suma = suma+ result;
            
        end
        % ============================================================
        
        % b. Actualizacion de las thetas
        % ====================== YOUR CODE HERE ======================
        % Resultado de la actualizacion de los parametros theta mediante descenso del gradiente
        theta = theta_old - alpha *((1/m)*suma); 
        % ============================================================
        
        % *********************
        % PASO 2:
        % Calcular el valor de la funcion de hipotesis h (salida estimada) 
        % PARA CADA ELEMENTO DEL CONJUNTO DE ENTRENAMIENTO CON LOS NUEVOS THETA
        ...
        %a. Resultado intermedio: Calcular el error PARA CADA ELEMENTO y sumar todos
        coste_total = 0;
        for i=1:m
            % ====================== YOUR CODE HERE ======================
            
             % Calculo del coste para el patron i-esimo y suma al coste de los
            % patrones anteriores
            coste_patron_i = fCalculaCosteRegLog(Y_train(i), h_train(i));
            coste_total = coste_total + coste_patron_i;
%             result = Y_train(i)* log(h_train(i)) +(1 - Y_train(i))* log(1-h_train(i));
%             coste_total = coste_total + result;
            % ============================================================
        end
