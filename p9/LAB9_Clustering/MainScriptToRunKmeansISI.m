...
% A. "Read" images
[CImaNamRed,ThePathRed]= fReadDirNamAndIma13('jpg','Select the folder with the red images','C:\Users\irene\Desktop\LAB9_Clustering\Color Images\Color Images\RedImages');
% CImaNamRed <2x35 cell>
% B. "Green" images
[CImaNamGreen,ThePathGreen]= fReadDirNamAndIma13('jpg','Select the folder with the red images','C:\Users\irene\Desktop\LAB9_Clustering\Color Images\Color Images\GreenImages');
% CImaNamGreen <2x35 cell>
% C. "Mixed" images, with Red and Green colors
[CImaNamMixed,ThePathMixed]= fReadDirNamAndIma13('jpg','Select the folder with the red images','C:\Users\irene\Desktop\LAB9_Clustering\Color Images\Color Images\MixedImages');
